...
void unit_test() {
  ...
  //   assert(lft::front_end(ascending1).size() == 2 && "front end trimming
  //   fail"); assert(lft::front_end(ascending2).size() == 3 && "front end
  //   trimming fail"); assert(lft::back_end(ascending1).size() == 3 && "back
  //   end trimming fail"); assert(lft::back_end(ascending2).size() == 3 &&
  //   "back end trimming fail");
  //
  //   // Min max
